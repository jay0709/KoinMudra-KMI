...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/koinmudra-cli.cpp \
           src/koinmudra-tx.cpp \
           src/koinmudra.cpp \
           src/db.cpp \
           ...
           src/qt/koinmudra.cpp \
           src/qt/koinmudrastrings.cpp \
...
RESOURCES += src/qt/koinmudra.qrc src/qt/koinmudra_locale.qrc

TRANSLATIONS += src/qt/locale/koinmudra_bg.ts \
                src/qt/locale/koinmudra_de.ts \
                src/qt/locale/koinmudra_en.ts \
                src/qt/locale/koinmudra_es.ts \
                src/qt/locale/koinmudra_fi.ts \
                src/qt/locale/koinmudra_fr.ts \
                src/qt/locale/koinmudra_it.ts \
                src/qt/locale/koinmudra_ja.ts \
                src/qt/locale/koinmudra_pl.ts \
                src/qt/locale/koinmudra_pt.ts \
                src/qt/locale/koinmudra_ru.ts \
                src/qt/locale/koinmudra_sk.ts \
                src/qt/locale/koinmudra_sv.ts \
                src/qt/locale/koinmudra_vi.ts \
                src/qt/locale/koinmudra_zh_CN.ts \
                src/qt/locale/koinmudra_zh_TW.ts
