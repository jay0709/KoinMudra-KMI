...
#   c) node1 mines 32 blocks, so now node 0 has 500000KMI, node 1 has 4250KMI, node2 has none.
#   d) node0 sends 601 KMI to node2, in two transactions (301 KMI, then 300 KMI).
