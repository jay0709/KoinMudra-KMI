...
In order to support loading of multiple wallets in koinmudra-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is koinmudra.cpp.
...
Changes to koinmudra.cpp
----------------------
koinmudra.cpp is the entry point into koinmudra-qt, and as such, will require some minor modifications to provide hooks for
