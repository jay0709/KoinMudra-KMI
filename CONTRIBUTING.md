Contributing to Koinmudra Core
==================================

The Koinmudra Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Koinmudra Core project, and is not to be
confused with overall Koinmudra Network Protocol consensus changes.

Whether a pull request is merged into Koinmudra Core rests with the project merge
...
The project leader is the release manager for each Koinmudra Core release.
