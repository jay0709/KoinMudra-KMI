...
/** Utility functions used by the Koinmudra Qt UI.
 */
namespace GUIUtil
{
...
// Render KMI addresses in monospace font
...
// Parse "koinmudra:" URI into recipient object, return true on successful parsing
