                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Koinmudra Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Koinmudra Core"), this);
    aboutAction->setStatusTip(tr("Show information about Koinmudra Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Koinmudra Core help message to get a list with possible Koinmudra command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Koinmudra Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Koinmudra Core"); // default title
