...
/* Koinmudra GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Koinmudra"
#define QAPP_ORG_DOMAIN "koinmudra.com"
#define QAPP_APP_NAME_DEFAULT "Koinmudra-Qt"
#define QAPP_APP_NAME_TESTNET "Koinmudra-Qt-testnet"
