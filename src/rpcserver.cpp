...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Koinmudra server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Koinmudra server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Koinmudra features */
        {"koinmudra", "masternode", &masternode, true, true, false},
        {"koinmudra", "listmasternodes", &listmasternodes, true, true, false},
        {"koinmudra", "getmasternodecount", &getmasternodecount, true, true, false},
        {"koinmudra", "masternodeconnect", &masternodeconnect, true, true, false},
        {"koinmudra", "masternodecurrent", &masternodecurrent, true, true, false},
        {"koinmudra", "masternodedebug", &masternodedebug, true, true, false},
        {"koinmudra", "startmasternode", &startmasternode, true, true, false},
        {"koinmudra", "createmasternodekey", &createmasternodekey, true, true, false},
        {"koinmudra", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"koinmudra", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"koinmudra", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"koinmudra", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"koinmudra", "getmasternodescores", &getmasternodescores, true, true, false},
        {"koinmudra", "mnbudget", &mnbudget, true, true, false},
        {"koinmudra", "preparebudget", &preparebudget, true, true, false},
        {"koinmudra", "submitbudget", &submitbudget, true, true, false},
        {"koinmudra", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"koinmudra", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"koinmudra", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"koinmudra", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"koinmudra", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"koinmudra", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"koinmudra", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"koinmudra", "checkbudgets", &checkbudgets, true, true, false},
        {"koinmudra", "mnsync", &mnsync, true, true, false},
        {"koinmudra", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> koinmudra-cli " + methodname + " " + args + "\n";
}
